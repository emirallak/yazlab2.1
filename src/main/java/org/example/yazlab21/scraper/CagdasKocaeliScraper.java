...
public class CagdasKocaeliScraper
{

    private final HaberRepository haberRepository;

    public void scrapeCagdasKocaeli(int days)
    {
        ...
        System.out.println(" Selenium WebDriver Başlatılıyor (Çağdaş Kocaeli)...");
        ...
        List<String> kategoriLinkleri = Arrays.asList("https://www.cagdaskocaeli.com.tr/arsiv/kocaeli-gundem-haberleri", "https://www.cagdaskocaeli.com.tr/arsiv/kocaeli-asayis-haberleri");
        ...
        try {
            for (String baseUrl : kategoriLinkleri)
            {
                ...
                while (!eskiHaberSiniri && sayfaNumarasi <= 5)
                {
                    ...
                    System.out.println("\n Çağdaş Kocaeli Taranıyor (Sayfa " + sayfaNumarasi + "): " + url);
                    ...
                    for (Element kart : haberKartlari)
                    {
                        ...
                        {
                            link = "https://www.cagdaskocaeli.com.tr" + aTag.attr("href");
                        }
                        ...
                        try {
                            ...
                            if (!tarihStr.isEmpty())
                            {
                                ...
                                Haber yeniHaber = Haber.builder().baslik(baslik).icerik(tamIcerik).haberTuru(tur).link(link).kaynakAd("Çağdaş Kocaeli").yayinTarihi(haberZamani).build();
        ...
        {
            System.err.println("Çağdaş Kocaeli Taraması Çöktü: " + e.getMessage());
        }
        finally
        {
        ...
        System.out.println("\nÇağdaş Kocaeli işlemi tamamlandı.");
    }
